  ...
  return (
    <div className="relative">
      <Image
        ...
        width={300}
        height={300}
        className="-z-10 absolute lg:w-[250px] lg:right-0 xl:right-0 md:block hidden"
      />
      <Image
        ...
        width={300}
        height={300}
        className="-z-10 absolute lg:top-24 lg:-left-24 xl:left-0 top-52 md:block hidden"
      />
      <Image
      ...
      <Template fullScreen={true}>
        <div className="relative z-10 max-w-6xl container mx-auto  px-8 md:px-12 lg:px-20 2xl:px-0">
          <div className="flex flex-col md:grid md:grid-cols-2 items-start md:items-center justify-between gap-4">
            ...
            <Paragraph className="pl-0 md:pl-8">{data.description}</Paragraph>
